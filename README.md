...
| <a name="input_ami_housekeeper_lambda_s3_bucket"></a> [ami\_housekeeper\_lambda\_s3\_bucket](#input\_ami\_housekeeper\_lambda\_s3\_bucket) | S3 bucket from which to specify lambda functions. This is an alternative to providing local files directly. | `string` | `null` | no |
